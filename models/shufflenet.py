...
class ShuffleNetUnit(nn.Module):
    ...
    def __init__(self, input_channels, output_channels, stage, stride, groups, group1=None):
        super().__init__()
...
class ShuffleNet(nn.Module):
    ...
    def __init__(self, num_blocks, num_classes=1000, groups=3):
        ...
        self.conv1 = BasicConv2d(3, out_channels[0], 3, padding=1, stride=2)
